                                    ...
                                    @foreach ($savedJobs as $savedJob)
                                        <tr class="active">
                                            <td>
                                                ...
                                                <div class="info1">{{ $savedJob->job->jobNature->name }} . {{ $savedJob->job->location }}</div>
                                            </td>
                                            ...
                                            <td>
                                                <div class="action-dots">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-end">
                                                        ...
                                                        <li>
                                                            <form action="{{ route('account.removeSavedJob', ['id' => $savedJob->id]) }}" method="POST" onsubmit="return confirmDeleteSaved(event)">
                                                                @csrf
                                                                @method('DELETE')
...
@section('customJs')
<script>
    function confirmDeleteSaved(event) {
