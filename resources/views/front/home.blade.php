                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="bg-light p-3 border">
                                            ...
                                            <p class="mb-0">
                                                ...
                                                <span class="ps-1">{{ $featuredJob->jobNature->name }}</span>
                                            </p>
                                        ...
                                        <div class="d-grid mt-3">
                                            <a href="{{ route('jobDetail', ['id' => $featuredJob->id]) }}" class="btn btn-primary btn-lg">Details</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card border-0 p-3 shadow mb-4">
                                    <div class="card-body">
                                        ...
                                        <div class="bg-light p-3 border">
                                            ...
                                            <p class="mb-0">
                                                <span class="fw-bolder"><i class="fa fa-clock-o"></i></span>
                                                <span class="ps-1">{{ $latestJob->jobNature->name }}</span>
                                            </p>
                                        ...
                                        <div class="d-grid mt-3">
                                            <a href="{{ route('jobDetail', ['id' => $latestJob->id]) }}" class="btn btn-primary btn-lg">Details</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
